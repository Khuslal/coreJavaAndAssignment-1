...
3. Write a program to find sum and average of two numbers input by User (using Scanner
class).
4. Write a program to calculate Simple Interest input by user. Simple Interest = P*T*R/1005. Write a program to find the area of circle, rectangle, and triangle.
...
12. Write a program to accept the roll, name, and nationality of the person and display those
values in good format way.
13. Write a program to print the number entered by user only if the number entered is
negative.
...
24. Write a program to print the factorial number of given number
