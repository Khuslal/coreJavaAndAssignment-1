	...
	public static void main(String[] args) {
		...
		if(choice.equalsIgnoreCase("C")) {
			...
			// Perimeter of Rectangle
				...
				System.out.println("The perimeter of rectangle for length: "+length+" and width: "+width+" = "+rectangle);
			...
			System.out.println("The perimeter of triangle for side a : "+a+" b : "+b+" and c: "+c+" = "+triangle);
		}else {
